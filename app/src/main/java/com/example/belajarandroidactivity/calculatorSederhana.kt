...
class calculatorSederhana : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calculator_sederhana)
        ...
        val builder: AlertDialog.Builder = AlertDialog.Builder(this@calculatorSederhana)
